  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          return Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return ListTile(
                  title: Text(note.appID,style: TextStyle(fontSize: 16.0, color: Colors.white),),
                  subtitle: Text(note.doctorName,style: TextStyle(fontSize: 12.0, color: Colors.white),),
                  trailing: Row(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (_) => AddClinic()));
        },
      ),
    );
  }
